...
|---|---|---|
| Identity | Autentikasi, sesi, verifikasi, role, permission, policy. | Menulis ledger atau memutuskan transaksi. |
| CustomersRegions | Profil nasabah, nomor/kartu/QR, wilayah, area pelayanan, layanan berbantuan. | Menaruh data pribadi dalam QR. |
| WasteMaster | Kategori, jenis, satuan, kondisi, edukasi, periode harga. | Mengubah snapshot transaksi lama. |
...
| Statistics | Publikasi statistik agregat dan snapshot. | Menampilkan data pribadi nasabah. |
