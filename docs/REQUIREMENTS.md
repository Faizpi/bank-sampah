...
Dokumen ini menetapkan perilaku wajib untuk satu baseline pengembangan Sistem Informasi Bank Sampah Digital. Kode kebutuhan bersifat stabil dan menjadi referensi bagi [aturan bisnis](BUSINESS_RULES.md), [alur pengguna](USER_FLOWS.md), [model data](DATA_MODEL.md), [hak akses](PERMISSIONS.md), dan [rencana pengujian](TEST_PLAN.md).
...
| NFR-UX-001 | UI mobile-first Green Ledger mengikuti [DESIGN.md](DESIGN.md). | Lebar 360, 390, 768, dan 1280 px berfungsi tanpa scroll horizontal tak disengaja. |
...
Nomor mengacu pada urutan diagram pada kumpulan flowchart dan rincian [USER_FLOWS.md](USER_FLOWS.md).
