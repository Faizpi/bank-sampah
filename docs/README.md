# Dokumentasi Bank Sampah Digital

Dokumentasi ini menjelaskan kontrak produk, teknis, antarmuka, dan operasional Sistem Informasi Bank Sampah Digital.
...
- Kontrak produk dan teknis pada direktori ini.
- Proposal pengajuan dan kumpulan flowchart dikelola terpisah di luar repositori.
...
- [DESIGN.md](DESIGN.md) — kontrak Green Ledger untuk token, shell, komponen, state, responsive, dan aksesibilitas.
