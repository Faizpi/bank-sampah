...
final class ApplyResponseSecurityHeaders
{
    ...
    private static function mustNotIndex(Request $request): bool
    {
    ...
    {
        if ($request->user() !== null || $request->is('login', 'daftar', 'backoffice*', '*/login', 'media/*', 'laporan/ekspor/*')) {
            return true;
        }
