    ...
    */
    ...
    'roles' => [
        ...
        'petugas' => [
            ...
            'description' => 'Panduan operasional bagi petugas untuk melayani penjemputan dan setoran langsung.',
            'color' => 'blue',
        ],
        'bendahara' => [
            'label' => 'Bendahara',
    ...
    'items' => [
        ...
        [
            ...
            'steps' => [
                ...
                'Tunjukkan Kode QR di layar ponsel kepada Petugas saat setoran atau penjemputan tiba.',
            ],
        ...
        [
            ...
            'summary' => 'Cara masuk ke akun khusus petugas lapangan bank sampah.',
            'steps' => [
                ...
                'Periksa ringkasan tugas hari ini, draf setoran, dan status penjemputan.',
            ],
        ...
        [
            ...
            'role' => 'superadmin',
            'number' => '9',
            'title' => 'Tutorial Membuat Pengumuman',
            'summary' => 'Panduan mempublikasikan agenda dan informasi desa ke halaman publik.',
            'steps' => [
                'Buka menu "Pengumuman".',
                'Buat posting pengumuman baru berisi judul, tanggal kegiatan, dan isi informasi untuk warga.',
                'Tentukan periode tayang dan wilayah yang menjadi sasaran pengumuman.',
                'Publikasikan pengumuman agar langsung terbaca di beranda dan menu informasi publik.',
            ],
