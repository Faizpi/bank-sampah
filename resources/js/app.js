...
async function customerCardCanvas(card) {
    ...
    const area = card.querySelector('[data-customer-card-area]')?.textContent?.trim() ?? 'Area Layanan';
    ...
    context.fillText('Bank Sampah Digital', 72, 130);
    ...
    context.fillText('QR tanpa data saldo · Gunakan di layanan resmi Bank Sampah Digital', 72, 948);
