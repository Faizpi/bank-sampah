...
<html lang="id">
    <head>
        ...
        <title>{{ $statusCode }} · {{ $copy['title'] }} · Bank Sampah Digital</title>
        <style>
            :root {
                color-scheme: light;
                --canvas: #f7f8f4;
    ...
    <body>
        <div class="shell">
            <a class="brand" href="{{ route('home') }}" aria-label="Kembali ke beranda Bank Sampah Digital">
                <img src="{{ asset('images/landing/mascot-3.png') }}" alt="">
                <span>
                    <strong>Bank Sampah Digital</strong>
                    <span>Kelola sampah bersama</span>
                </span>
            </a>
                ...
                <section class="recovery" aria-labelledby="error-title">
                    ...
                    <div class="visual">
                        <div class="mascot-wrap">
                            <img src="{{ asset('images/landing/mascot-3.png') }}" alt="Maskot Bank Sampah Digital siap membantu Anda kembali ke beranda">
