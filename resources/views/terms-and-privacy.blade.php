...
@section('title', 'Ketentuan Operasional dan Kebijakan Privasi | Bank Sampah Digital')
@section('description', 'Ketentuan Operasional v1.0 dan Kebijakan Privasi Ringkas v1.0 Bank Sampah Digital.')
    ...
    <div class="public-canvas">
        <section class="border-b border-deep-green bg-deep-green text-surface" aria-labelledby="terms-title">
            <div class="public-container grid items-center gap-8 section-space lg:grid-cols-[1fr_auto]">
                ...
                <p class="mt-3 max-w-2xl text-body text-surface/80">Dokumen ini tersedia untuk dibaca sebelum pendaftaran dan berlaku untuk penggunaan layanan Bank Sampah Digital.</p>
                </div>
