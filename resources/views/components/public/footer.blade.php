...
<footer class="border-t border-deep-green bg-deep-green text-surface">
    <div class="public-container">
        <div class="grid gap-10 py-12 lg:grid-cols-[1.1fr_1.9fr] lg:gap-16 lg:py-16">
            <div class="max-w-md">
                <a href="{{ route('home') }}" class="inline-flex min-h-touch items-center gap-3 rounded-md focus-visible:outline-offset-4" aria-label="Bank Sampah Digital, beranda">
                    ...
                    <span>
                        ...
                        <span class="block text-body-sm font-medium text-success-bg">Kelola sampah bersama</span>
                    </span>
                </a>
