...
final class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private const PERMISSIONS = [
        ...
        'deposit.view' => 'Melihat setoran.', 'deposit.create' => 'Membuat setoran.', 'deposit.update-draft' => 'Memperbarui draf setoran.', 'deposit.finalize' => 'Memfinalisasi setoran.', 'deposit.approve' => 'Menyetujui atau menolak setoran bernilai tinggi.', 'transaction.correct' => 'Membuat koreksi transaksi final.', 'transaction.reverse' => 'Membuat reversal transaksi final.', 'ledger.view' => 'Melihat ledger.', 'ledger.adjust' => 'Membuat penyesuaian ledger.', 'correction.view-customer' => 'Melihat koreksi aman bagi warga.',
        'pickup.view' => 'Melihat penjemputan.', 'pickup.request' => 'Membuat pengajuan penjemputan.', 'pickup.review' => 'Meninjau penjemputan.', 'pickup.schedule' => 'Menjadwalkan penjemputan.', 'pickup.execute' => 'Menjalankan penjemputan.', 'pickup.complete' => 'Menyelesaikan penjemputan.', 'pickup.cancel' => 'Membatalkan penjemputan.', 'withdrawal.request' => 'Membuat pencairan.', 'withdrawal.view' => 'Melihat pencairan.', 'withdrawal.approve' => 'Menyetujui pencairan.', 'withdrawal.pay' => 'Membayar pencairan.', 'withdrawal.cancel' => 'Membatalkan pencairan.', 'grocery.package.view' => 'Melihat paket sembako.', 'grocery.package.manage' => 'Mengelola paket sembako.', 'grocery.request' => 'Membuat penukaran sembako.', 'grocery.view' => 'Melihat penukaran sembako.', 'grocery.approve' => 'Menyetujui penukaran sembako.', 'grocery.prepare' => 'Menyiapkan paket sembako.', 'grocery.handover' => 'Menyerahkan paket sembako.', 'grocery.cancel' => 'Membatalkan penukaran sembako.',
        'notification.view' => 'Melihat notifikasi sendiri.', 'announcement.view' => 'Melihat pengumuman.', 'announcement.manage' => 'Mengelola pengumuman.', 'announcement.publish' => 'Menerbitkan pengumuman.', 'target.view' => 'Melihat target.', 'target.manage' => 'Mengelola target.', 'target.publish' => 'Menerbitkan target.', 'statistics.internal.view' => 'Melihat statistik internal.', 'statistics.public.manage' => 'Mengelola publikasi statistik.', 'qr-verification.rotate' => 'Merotasi token verifikasi QR.',
        'report.view' => 'Melihat laporan.', 'report.export' => 'Mengekspor laporan.', 'audit.view' => 'Melihat audit log tersanitasi.', 'reconciliation.view' => 'Melihat area rekonsiliasi.', 'reconciliation.create' => 'Membuat permintaan rekonsiliasi.', 'reconciliation.approve' => 'Menyetujui rekonsiliasi.', 'system.settings.manage' => 'Mengelola pengaturan sistem.', 'system.maintenance' => 'Menjalankan maintenance sistem.', 'backup.run' => 'Menjalankan backup.', 'backup.view' => 'Melihat backup.', 'backup.restore' => 'Memulihkan backup.', 'audit.retention.execute' => 'Menjalankan retensi audit.', 'media.retention.execute' => 'Menjalankan retensi foto penjemputan.',
    ];
    ...
    private const SUPERADMIN_TECHNICAL_PERMISSIONS = [
        'role.manage', 'reconciliation.view', 'reconciliation.create', 'reconciliation.approve', 'system.settings.manage', 'system.maintenance', 'backup.run', 'backup.view', 'backup.restore', 'audit.retention.execute', 'media.retention.execute',
    ];
    ...
    private const SUPERADMIN_RECONCILIATION_PERMISSIONS = [
        'deposit.approve', 'transaction.correct', 'transaction.reverse', 'ledger.adjust',
    ];
